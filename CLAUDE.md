...
Built for use with Claude Code + Stata MCP, with optional R support
...
- Researcher restricts the sample in a way that conflicts with the
  parallel trends test setup
